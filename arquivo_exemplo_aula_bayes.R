...
spam_train_labels <- spam_train$type

spam_test <- spam_rand[3001:4601,]
spam_test_labels <- spam_test$type
...
spam_test_pred <- predict(spam_classifier, spam_test, type="class")
...
spam_test_pred2 <- predict(spam_classifier2, spam_test_matrix)
